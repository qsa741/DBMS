...
public class DbmsServiceImpl implements DbmsService {
	...
	public List<TreeDTO> getAllSchemas() throws ClassNotFoundException, SQLException {
		System.out.println(sessionService.getSessionId());
		System.out.println(sessionService.getSessionDbId());
		System.out.println(sessionService.getSessionDbPw());
	...
	@Override
	public Map<String, Object> tableDetailsTable(String table, String schema) throws ClassNotFoundException, SQLException {
		Map<String, Object> info = new HashMap<String, Object>();
		Map<String, Object> result = new HashMap<String, Object>();
		List<Map<String, Object>> rows = new ArrayList<Map<String, Object>>();

		info = dbmsSQL.tableDetailsTable(table, schema);
